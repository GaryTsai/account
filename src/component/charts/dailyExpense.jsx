        ...
        <div className="App">
          ...
          >
            <div
              key={"pie-chart"}
              style={
                type === "categoryExpense" ? styles.activeChart : styles.chart
              }
            ...
            <div
              key={"account-chart"}
              style={
                type === "accountExpense" ? styles.activeChart : styles.chart
              }
            ...
            <div
              key={"bar-chart"}
              style={
                type === "dailyExpense" ? styles.activeChart : styles.chart
              }
